...
func handleQuerychr(args []interface{}){
	...
	querychrr:=msg.NewMir2Message_with_msg_soul_wparam_atag_nseries(msg.SM_QUERYCHR,2,0,0,0,players...)
...
func handleSelchr(args []interface{}){
	...
	selchrr:=msg.NewMir2Message_with_msg_soul_wparam_atag_nseries(msg.SM_STARTPLAY,0,0,0,0,"127.0.0.1","7004")
	a.WriteMsg(selchrr)
}
func handleGamelogin(args []interface{}){
	...
	notice:=`测试公告`
	gameloginr:=msg.NewMir2Message_with_msg_soul_wparam_atag_nseries(msg.SM_SENDNOTICE,int32(len(notice)),0,0,0,notice)
...
func handleLoginnoticeok(args []interface{}){
	...
	loginnoticeokr:=msg.NewMir2Message_with_msg_soul_wparam_atag_nseries(msg.SM_LOGON,1000,273,590,((1<<8)|1),string(btbuf))
...
func handleQuerybagitems(args []interface{}){
	...
	log.Debug("%v",m)
	querybagitemsr:=msg.NewMir2Message_with_msg_soul_wparam_atag_nseries(msg.SM_BAGITEMS,1,0,0,0)
